...
Future<Map<String, dynamic>> getStoredData() async {
  ...
  if (prefs.getString('user') != null) {
    driver = DriverModel.fromJson(prefs.getString('user')!);
  } else {
    driver = null;
  }
...
Future<DriverModel?> getMe(String accessToken) async {
  try {
    ...
    if (res.statusCode == 200) {
      ...
      return data['user'] as DriverModel;
    }
  } catch (e) {
    print(e);
  }
...
Future<Map<String, dynamic>?> getNewCredential() async {
  ...
  DriverModel? user = await getMe(data["accessToken"]);
  if (user == null) {
